/*
  lcd_display_avr.h - Controlador para LCD 20x4 I2C compatible con AVR
  Versión optimizada para Arduino Uno/Nano
*/

#ifndef LCD_DISPLAY_AVR_H
#define LCD_DISPLAY_AVR_H
